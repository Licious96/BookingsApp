                            ...
                            <div className="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input className="form-control" id="f_name" type="text" defaultValue={user.f_name} />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label className="col-12 col-sm-3 col-form-label text-sm-right" for="inputPassword3">Last Name</label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input className="form-control" id="l_name" type="text" defaultValue={user.l_name} />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label className="col-12 col-sm-3 col-form-label text-sm-right" for="inputPlaceholder3">Module Name</label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input className="form-control" id="module_name" type="text" defaultValue={user.module_name} />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label className="col-12 col-sm-3 col-form-label text-sm-right">Module Code</label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input className="form-control" id="module_code" type="text" defaultValue={user.module_code} />
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input class="form-control" id="contacts" defaultValue={user.contacts} />
                                    </div>
                                </div>
